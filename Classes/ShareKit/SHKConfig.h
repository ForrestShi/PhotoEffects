...
#define SHKMyAppName			@"SocialCamera"
#define SHKMyAppURL				@"http://DesignForApple.com"
...
#define SHKFacebookKey				@"1d6ae1586e4c10b0542390ad42229513"
#define SHKFacebookSecret			@"92e3424b7f34746112c81e8311efc9d5"
 ...
 */
#define SHKTwitterConsumerKey		@"zp6bOIqhc8NJHXMNbVQgDg"
#define SHKTwitterSecret			@"DBeGs3nLPuuIspCdNV1LXZRCtMvL9wmdjvWxria0BJg"
#define SHKTwitterCallbackUrl		@"http://callbackurl.com" // You need to set this if using OAuth, see note above (xAuth users can skip it)
